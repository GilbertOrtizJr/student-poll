...
module.exports = configure(function ( ctx ) {
  return {
    ...
    build: {
      ...
      env: {
        BASE_URL: ctx.dev ? 'http://localhost:3000' : 'http://54.89.42.178',
        CREATOR_NAME: 'Gilbert Ortiz Jr',
        CREATOR_EMAIL: 'gilbert.ortiz@bronxsoftware.org',
        LINKEDIN: 'https://www.linkedin.com/in/gilbert-ortiz-2b8122254/',
